    ...
    <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
      ...
      <div class="modal-content py-4 text-left px-6">
        ...
        <div class="flex justify-between items-center pb-3">
          <p class="text-2xl font-bold">{{ $t('user.login') }}</p>
        ...
        <div class="flex flex-col justify-center items-center">
          <button class="bg-twitter border border-twitter rounded text-white py-2 px-3 mb-2"><i class="mdi mdi-twitter mr-1"></i>{{ $t('user.loginWith') }}Twitter</button>
          <button @click="loginWithGithub" class="bg-gray-600 border border-gray rounded text-white py-2 px-3 mb-2">
            <i class="mdi mdi-github mr-1"></i>{{ $t('user.loginWith') }}GitHub
          </button>
        </div>
